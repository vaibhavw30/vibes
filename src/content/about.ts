...
export const aboutBody = [
  ...
  "At Georgia Tech I study computer science with a math minor, graduating in 2028. My work splits between software engineering, machine learning research, and quant finance, and I like that they keep running into each other. So far that's meant software internships at a sports prediction startup and a data platform, ML infrastructure for satellite imagery, and research on steering truth directions inside language models. Since August I've been a quant on Georgia Tech's $3.1M student-managed fund and a prosthesis researcher at the EPIC lab.",
